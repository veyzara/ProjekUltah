...
new TypeIt("#teks1", {
  strings: ["Moshii Moshi><", " ", "Ini darii ksyangan nijarr", " ", "<b>Happy birthdayy !!</b>", " ", "Semoga nijar panjang umur, makin sayang claraa, jgn bosen yaa sma i.", , " ", "Hihi, luv u <3", " ", "- Claraa, ur favgurl ><"],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Elloww sayang !!", "Pibesdey yaa..", " ", "Ciee uda 16 taunn hihi moga nijar makin pinter, rajin.", "Keanyaa emg gni doang, clara bru prtama jadi kmrin" mungkin rada susah ngeubah" teksnyaa hihi tp moga nijar cukaa >.<", "Sekali lagi, Selamat Ulang Tahun yaa. Semoga semua impian, keinginan, dan harapan nijarr bisa tercapai, makasii uda selalu sma claraa."],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
